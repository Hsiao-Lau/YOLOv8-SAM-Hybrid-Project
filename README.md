# Prerequisites
 ## Dataset
 Both dataset its details could be found at its original website.    
 （1）Prostate158[](https://github.com/kbressem/prostate158)  
...
```
## Running
Make sure that the dependencies are installed and the directory structure is organized as is in this repo, run the `test_demo_pipeline.py` and the pipeline demo will start the model.
